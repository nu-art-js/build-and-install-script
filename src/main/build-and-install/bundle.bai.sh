...
source <(curl -fsSL https://github.com/nu-art/bash-tools/releases/latest/download/bundle.loader.sh) --sh-bundle lib.tools -sh-f

import "./backup.sh"
import "./build-and-install.sh"
import "./cli.sh"
import "../generate-ssl-certificate/ssl.sh"
